...
public:
	...
	// I believe that these ints encode the position of the Marker data in the GLOBAL stream of all markers
	// e.g. if we have 2 channels, we would create 2 MarkerChannel objects once at startup with the following values:
	// MC1 {X = 0; Y = 1; Z = 2; O = 3}; MC2 {X = 4 ; Y = 5; Z = 6; O = 7}
	// where e.g. the X coord of MC1 is stored in the first vector element and the X coord of MC2 is stored in the fifth ...
	int X;
	int Y;
	int Z;
	int O;
